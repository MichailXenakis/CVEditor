...
//		onExit(CombinedJFrameWindow, false);
		...
		createButton(btnSkillsAndExperience, 368, 23, 154, 51);
		
		JButton btnProfessionalExperience = new JButton("Professional Experience");
		createButton(btnProfessionalExperience, 550, 23, 154, 51);
		
		JButton btnEducationAndTraining = new JButton("Education And Training");
		createButton(btnEducationAndTraining, 10, 109, 154, 57);
		...
		createButton(btnAdditionalInformation, 368, 110, 154, 56);
		...
		createPanel(panel, 0, 205, 719, 116);
		...
		ChooseFileType combinedtype=new ChooseFileType(chckbxTxt, chckbxTex, appMainWindow,this); 
		btnSave.addActionListener(combinedtype);		
	}

	
	public void createButton(JButton btn, int x, int y, int width, int height) {
    	btn.setBounds(x, y, width, height);
        CombinedJFrameWindow.getContentPane().add(btn);
    }
	
	
	public void createCheckBox(JCheckBox chckbx, int x, int y, int width, int height, int hTextPos) {
	    chckbx.setHorizontalAlignment(hTextPos);
        chckbx.setBounds(x, y, width, height);
        CombinedJFrameWindow.getContentPane().add(chckbx);
