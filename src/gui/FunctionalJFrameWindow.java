...
//		onExit(FunctionalJFrameWindow, false);
	    ...
	    createButton(btnCareerSummary, 550, 23, 154, 51);
		...
		ChooseFileType functionaltype=new ChooseFileType(chckbxTxt, chckbxTex, appMainWindow,this); 
        btnSave.addActionListener(functionaltype);
		
	}
	
	public void createButton(JButton btn, int x, int y, int width, int height) {
        btn.setBounds(x, y, width, height);
        FunctionalJFrameWindow.getContentPane().add(btn);
    }
    ...
    public void createCheckBox(JCheckBox chckbx, int x, int y, int width, int height, int hTextPos) {
        ...
        FunctionalJFrameWindow.getContentPane().add(chckbx);
