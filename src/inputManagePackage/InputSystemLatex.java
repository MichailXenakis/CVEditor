...
public class InputSystemLatex extends InputSystem{
	...
	public InputSystemLatex(){
        this.generalInfoEndTagLength = 2;
    }
...
*/		
	...
	private void inputCvAddSection(int sectionCounter, CVTemplate cvtemplate) throws ParseException{
...
//		if(checkNextLine.equals("Professional Profile:")){
		...
		}else if(isDoubleParagraphSection(checkNextLine)){
...
*/			
	...
	private static boolean isDoubleParagraphSection(String checkNextLine) {
        if(checkNextLine.equals("Further Courses:") || checkNextLine.equals("Career Summary:") || checkNextLine.equals("Skills and Experience:")) {
            return true;
        }
        return false;
    }
